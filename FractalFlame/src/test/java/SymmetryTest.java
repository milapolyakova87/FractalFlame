...
public class SymmetryTest {
    public static void main(String[] args) throws IOException {
        ...
        // Генерация изображения с симметрией
        BufferedImage symmetricImage = fractalFlame.generateFlameWithSymmetry(4);

        // Сохранение изображений для сравнения
        ImageIO.write(image, "png", new File("original_flame.png"));
        ImageIO.write(symmetricImage, "png", new File("symmetric_flame.png"));
    }
}
